...
public class MainClass {
	...
	//Deze begint met de ant logica. komt na formatmove.
	...
	//Na formatMove komt deze, gaat stap voor stap de moves af.
	public static String checkSurroundings(AntClass ant) {
		...
		if (harvestOrNot(ant) == true) {
			return "H";
		}

//		if (ant.food > 250) {
//			if (ant.missionType.equals("moveOut")) {
